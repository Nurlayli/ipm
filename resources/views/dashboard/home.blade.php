    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/tambah-peserta">
              <span class="menu-title">Tambah Peserta</span>
            ...
            <span class="nav-link">
              <div class="border-bottom">
               ...
               <form action="/logout" method="post">
                  @csrf
                  <button class="btn btn-block btn-lg btn-gradient-primary mt-4" type="submit">LOG OUT</button>
                </form>
